========================================================================
    ACTIVEX CONTROL DLL : AVPlayer Project Overview
========================================================================

ControlWizard has created this project for your AVPlayer ActiveX Control
...
that make up your AVPlayer ActiveX Control DLL.
...
AVPlayer.ico
    ...
    is included by the main resource file AVPlayer.rc.

/////////////////////////////////////////////////////////////////////////////
CAVPlayerCtrl control:

AVPlayerCtrl.h
    This file contains the declaration of the CAVPlayerCtrl C++ class.

AVPlayerCtrl.cpp
    This file contains the implementation of the CAVPlayerCtrl C++ class.

AVPlayerPropPage.h
    This file contains the declaration of the CAVPlayerPropPage C++ class.

AVPlayerPropPage.cpp
    This file contains the implementation of the CAVPlayerPropPage C++ class.

CAVPlayerCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CAVPlayerCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file AVPlayer.rc.
...
stdafx.h, stdafx.cpp
    ...
    named AVPlayer.pch and a precompiled types (PCT) file named stdafx.obj.
